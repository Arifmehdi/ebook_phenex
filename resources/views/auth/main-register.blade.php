                                                                        ...
                                                                        <div id="ur-membership-registration"
                                                                            ...
                                                                            <div id="urm-membership-list"
                                                                                ...
                                                                                <label
                                                                                    ...
                                                                                    for="ur-membership-select-membership-466">
                                                                                    <input
                                                                                        class="ur_membership_input_class ur_membership_radio_input ur-frontend-field"
                                                                                        data-key-name="ur-membership-id"
                                                                                        id="ur-membership-select-membership-466"
                                                                                        type="radio"
                                                                                        name="urm_membership"
                                                                                        data-name=membership_field_1755577792
                                                                                        data-label=membership
                                                                                        required="required" value="466"
                                                                                        data-urm-pg='{&quot;paypal&quot;:&quot;on&quot;,&quot;bank&quot;:&quot;on&quot;}'
                                                                                        data-urm-pg-type="paid"
                                                                                        data-urm-pg-calculated-amount="5000">
                                                                                    <span
                                                                                        class="ur-membership-duration">Platinum</span>
                                                                                    <span
                                                                                ...
                                                                                <label
                                                                                    class="ur_membership_input_label ur-label"
                                                                                    for="ur-membership-select-membership-465">
                                                                                    <input
                                                                                        class="ur_membership_input_class ur_membership_radio_input ur-frontend-field"
                                                                                        data-key-name="ur-membership-id"
                                                                                        id="ur-membership-select-membership-465"
                                                                                        type="radio"
                                                                                        name="urm_membership"
                                                                                        data-name=membership_field_1755577792
                                                                                        data-label=membership
                                                                                        required="required" value="465"
                                                                                        data-urm-pg='{&quot;paypal&quot;:&quot;on&quot;,&quot;bank&quot;:&quot;on&quot;}'
                                                                                        data-urm-pg-type="paid"
                                                                                        data-urm-pg-calculated-amount="200">
                                                                                    <span
                                                                                        class="ur-membership-duration">Silver</span>
                                                                                    <span
                                                                                        class="ur-membership-duration">
                                                                                        - ৳ 200</span>
                                                                                </label>
                                                                                <label
                                                                                    class="ur_membership_input_label ur-label"
                                                                                    for="ur-membership-select-membership-464">
                                                                                    <input
                                                                                        class="ur_membership_input_class ur_membership_radio_input ur-frontend-field"
                                                                                        data-key-name="ur-membership-id"
                                                                                        id="ur-membership-select-membership-464"
                                                                                        type="radio"
                                                                                        name="urm_membership"
                                                                                        data-name=membership_field_1755577792
                                                                                        data-label=membership
                                                                                        required="required" value="464"
                                                                                        data-urm-pg='{&quot;paypal&quot;:&quot;on&quot;,&quot;bank&quot;:&quot;on&quot;}'
                                                                                        data-urm-pg-type="paid"
                                                                                        data-urm-pg-calculated-amount="2000">
                                                                                    <span
                                                                                        class="ur-membership-duration">Gold</span>
                                                                                    <span
                                                                                        class="ur-membership-duration">
                                                                                        - ৳ 2000</span>
                                                                                </label>
...
document.addEventListener('DOMContentLoaded', function() {
    const membershipRadios = document.querySelectorAll('input[name="urm_membership"]');
    ...
    function handleMembershipChange() {
        const selectedRadio = document.querySelector('input[name="urm_membership"]:checked');
        
        if (selectedRadio) {
            // Remove hiding classes and set display to block
            ...
            // Update total value
            const amount = selectedRadio.dataset.urmPgCalculatedAmount;
            totalInput.value = amount;
            
            // Also make the total input visible
            totalInput.style.display = 'block';
        } else {
            // Hide containers if no radio is selected
