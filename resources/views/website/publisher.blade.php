                                                ...
                                                @foreach($publisherChunk as $publisher)
                                                    <div class="elementor-element elementor-element-22e49e9 e-con-full e-flex wpr-particle-no wpr-jarallax-no wpr-parallax-no wpr-sticky-section-no e-con e-child"
                                                        ...
                                                        <div class="elementor-element elementor-element-8be4d85 elementor-position-top elementor-widget elementor-widget-image-box"
                                                            data-id="8be4d85" data-element_type="widget" data-widget_type="image-box.default">
                                                            <div class="elementor-image-box-wrapper">
                                                                <figure class="elementor-image-box-img">
                                                                    <a href="#" tabindex="-1">
                                                                        <img fetchpriority="high" decoding="async" width="225" height="225"
                                                                            src="{{ asset('storage/department_images/' . $publisher->image) }}"
                                                                            class="attachment-full size-full wp-image-387"
                                                                            alt="{{ $publisher->name_en }}"
                                                                            srcset="{{ asset('storage/department_images/' . $publisher->image) }}"
